...
const Page = ({ clicked, delay, children }: RootPageProps) => {
  return (
    <AnimatedContainer
      ...
      delay={delay}
    >
      <div className="w-full h-full flex flex-col justify-center items-center absolute text-black">
        {children}
      </div>
    </AnimatedContainer>
  );
  ...
  return (
    <>
      ...
      <Page clicked={clicked} delay={INITIAL_PAGE_DELAY}>
        <div className="w-1/2 2xl: h-full flex flex-col justify-center items-start text-black">
